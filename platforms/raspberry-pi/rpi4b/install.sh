...
# Pi 4B, CM4, Zero 2 W, and the Pi 3 family. Pi 5 is rejected because
# it uses RP1-CFE, not legacy unicam: for Pi 5 use platforms/raspberry-pi/rpi5/.
#
...
if echo "$COMPAT" | grep -q "brcm,bcm2712"; then
  ...
  Detected: $MODEL
  For Pi 5 use: platforms/raspberry-pi/rpi5/"
fi
